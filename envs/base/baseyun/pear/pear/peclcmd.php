...
if ('E:\desktop\virtual_env\envs\t\baseyun\pear\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('E:\desktop\virtual_env\envs\t\baseyun\pear\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
